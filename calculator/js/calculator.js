...
function Input_Digit(digit) {
    ...
    //we are clicking to see if Wait_Second_Operand is true and set
...
//this section handels decimals points 
function Input_Decimal(dot) {
    //this ensures that accenental clicking of the decimal point
    //doesn't cause bugs in your operatin 
    if (Calculator.Wait_Second_Operand === true) return; 
    if (!Calculator.Display_Value.includes(dot)) {
    //we are sayinf that if the Display_value does not contain a decimal point
    //we want to add a decimal point
        Calculator.Display_Value += dot;
  }
}

//this section handels operatores
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator lready exists and if Wait_Second_Operand is true,
